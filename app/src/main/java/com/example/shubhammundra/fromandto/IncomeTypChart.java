...
public class IncomeTypChart extends AppCompatActivity
{
    BarChart bc1,bc2;
    ImageView im2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.income_report_chart);
...
///////////
        ...
        bc1.setDescription("Income by Type");
        bc1.setDescriptionTextSize(18f);

        bc2.setDescription("Income by Cashier");
